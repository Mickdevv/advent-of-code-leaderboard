"""
Django settings for advent_of_code_leaderboard project.
...
ROOT_URLCONF = 'advent_of_code_leaderboard.urls'
...
WSGI_APPLICATION = 'advent_of_code_leaderboard.wsgi.application'
